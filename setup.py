...
class generate_configuration_files(Command):
    description = "Generate configfiles from old aspire-server and/or bitcoind config files"
    user_options = []
...
setup_options = {
    ...
    'author_email': 'support@aspire.io',
    'maintainer': 'Counteparty Developers',
    'maintainer_email': 'dev@aspire.io',
    'url': 'http://aspire.io',
    'license': 'MIT',
    'description': 'aspireblock server',
    'long_description': 'Implements support for extended functionality for aspire-lib',
    'keywords': 'aspire, bitcoin, aspireblock',
    'classifiers': [
        "Programming Language :: Python",
    ],
    'download_url': 'https://github.com/CounterpartyXCP/aspireblock/releases/tag/%s' % config.VERSION,
